...
```
npm create cloudflare@latest -- --template=cloudflare/templates/shiny-surf-662c
```

A live public deployment of this template is available at [https://shiny-surf-662c.templates.workers.dev](https://shiny-surf-662c.templates.workers.dev)
